...
Options:
  ...
  --file-key <key>        File key (required with --list-pages, --list-file-component-sets, --list-component-set-properties, --inspect-component-set, and --inspect-node)
  --node-id <id>          Node id (required with --list-component-set-properties, --inspect-component-set, and --inspect-node)
